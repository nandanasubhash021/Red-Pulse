...
function BloodBankDashboard() {
  ...
  const fetchProfile = async () => {
    ...
    try {
      const res = await fetch('https://red-pulse-ivory.vercel.app/api/auth/bloodbank/me', {
  ...
  const handleUpdateInventory = async (action) => {
    ...
    try {
      ...
      const res = await fetch('https://red-pulse-ivory.vercel.app/api/auth/bloodbank/inventory', {
        method: 'PUT',
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      ...
      const res = await fetch('https://red-pulse-ivory.vercel.app/api/auth/bloodbank/profile', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json', 'Authorization': `Bearer ${token}` },
